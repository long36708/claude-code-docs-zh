---
title: Claude Opus 4.5 系统提示
url: https://platform.claude.com/docs/zh-CN/release-notes/system-prompts/claude-opus-4-5
description: 查看 [claude.ai](https://claude.ai)、[Claude iOS 应用](https://anthropic.com/ios)和 [Claude Android 应用](https://anthropic.com/android)上 Claude Opus 4.5 核心系统提示的更新。
---

以下各日期版本之间的更改以 `**` 包围更改的文本进行标记。
