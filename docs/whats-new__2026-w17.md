...
<div className="digest-meta">
  <span>发布版本 <a href="/docs/en/changelog#2-1-114">v2.1.114 → v2.1.119</a></span>
...
<div className="digest-feature">
  ...
  <a className="digest-feature-link" href="/docs/zh-CN/ultrareview">Ultrareview 指南</a>
</div>
...
<div className="digest-feature">
  ...
  <a className="digest-feature-link" href="/docs/zh-CN/interactive-mode#session-recap">交互模式：会话摘要</a>
</div>
...
<div className="digest-feature">
  ...
  <a className="digest-feature-link" href="/docs/zh-CN/terminal-config#create-a-custom-theme">终端配置：创建自定义主题</a>
</div>
...
<div className="digest-feature">
  ...
  <a className="digest-feature-link" href="/docs/zh-CN/claude-code-on-the-web">网页版 Claude Code</a>
</div>
...
<div className="digest-wins">
  ...
  <div className="digest-wins-grid">
    <div><a href="/docs/zh-CN/interactive-mode#vim-editor-mode">Vim 可视模式</a>：在提示输入中按 <code>v</code> 进行字符选择或按 <code>V</code> 进行行选择，带有运算符和可视反馈</div>
    <div>Hooks 现在可以通过 <a href="/docs/zh-CN/hooks#mcp-tool-hook-fields"><code>type: "mcp\_tool"</code></a> 直接调用 MCP 工具，因此 hook 可以访问已连接的服务器，而无需生成进程</div>
    <div><code>/cost</code> 和 <code>/stats</code> 已合并到 <a href="/docs/zh-CN/commands"><code>/usage</code></a>；旧名称仍然可用作打开相关选项卡的输入快捷方式</div>
    <div><code>/config</code> 更改（主题、编辑器模式、详细信息等）现在持久化到 <code>\~/.claude/settings.json</code>，并遵循与其他 <a href="/docs/zh-CN/settings">设置</a> 相同的项目/本地/策略优先级</div>
    <div><a href="/docs/zh-CN/sub-agents#fork-the-current-conversation">分叉的子代理</a> 可以通过 <code>CLAUDE\_CODE\_FORK\_SUBAGENT=1</code> 在外部构建上启用：分叉继承您的完整对话上下文，而不是从头开始</div>
    <div>Pro 和 Max 订阅者在 Opus 4.6 和 Sonnet 4.6 上的默认 <a href="/docs/zh-CN/model-config#adjust-effort-level">努力级别</a> 现在是 <code>high</code>（之前是 <code>medium</code>）</div>
