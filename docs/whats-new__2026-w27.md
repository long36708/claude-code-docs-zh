...
<div className="digest-meta">
  <span>发布版本 <a href="/docs/en/changelog#2-1-195">v2.1.195 → v2.1.201</a></span>
...
<div className="digest-feature">
  ...
  <a className="digest-feature-link" href="/docs/zh-CN/sub-agents#run-subagents-in-foreground-or-background">在前台或后台运行子代理</a>
</div>
...
<div className="digest-feature">
  ...
  <a className="digest-feature-link" href="/docs/zh-CN/desktop-linux">Claude Desktop on Linux</a>
</div>
...
<div className="digest-wins">
  ...
  <div className="digest-wins-grid">
    <div><a href="/docs/zh-CN/artifacts">Artifacts</a> 现已正式推出，包含在 Pro 和 Max 计划中，加入 Team 和 Enterprise</div>
    <div>管理员可以在组织控制台中设置 <a href="/docs/zh-CN/model-config#organization-default-model">组织默认模型</a>；当您尚未选择模型时，它在 <code>/model</code> 中显示为"组织默认"</div>
