...
| `skills/.trash/`、`plugins/.trash/`                                                                                             | 从 claude.ai 同步的 [Skills](/docs/zh-CN/skills#how-synced-skills-behave) 和 [plugins](/docs/zh-CN/plugins-reference#synced-plugins)，Claude Code 已删除。移到此处而不是删除，以便您可以恢复文件                     |
