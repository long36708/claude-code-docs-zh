...
| 仅在您的用户设置中启用的 Plugins                                                                                                              | 否                                                 | 用户范围的 `enabledPlugins` 位于您机器上的 `~/.claude/settings.json`。请改为为您的 claude.ai 账户启用它们，以便 Claude Code 将它们作为[同步 plugins](/docs/zh-CN/plugins-reference#synced-plugins)加载                                                                                                                                                                            |
