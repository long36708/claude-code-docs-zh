...
| `github.com`                         | 克隆 GitHub 托管的[插件市场](/docs/zh-CN/plugin-marketplaces)和插件，包括官方 Anthropic 市场，通过 HTTPS 或 SSH。要仅通过 HTTPS 克隆 GitHub `owner/repo` 源，请设置 [`CLAUDE_CODE_PLUGIN_PREFER_HTTPS=1`](/docs/zh-CN/env-vars)                                                                                                                                                                                                                                                            |
