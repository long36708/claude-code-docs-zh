...
url: https://platform.claude.com/docs/zh-CN/models/opus-4-8/overview
description: Claude Opus 4.8 参考：生命周期状态、各平台上的模型 ID、上下文窗口、输出限制、定价和迁移资源。Claude Opus 4.8 是旧版模型；Claude Opus 5 是当前的 Opus 模型。
---
...
| [Amazon Bedrock](https://platform.claude.com/docs/zh-CN/build-with-claude/claude-in-amazon-bedrock)       | `anthropic.claude-opus-4-8` |
| [Google Cloud](https://platform.claude.com/docs/zh-CN/build-with-claude/claude-on-vertex-ai)              | `claude-opus-4-8`           |
| [Microsoft Foundry](https://platform.claude.com/docs/zh-CN/build-with-claude/claude-in-microsoft-foundry) | `claude-opus-4-8`           |
| [Claude Platform on AWS](https://platform.claude.com/docs/zh-CN/build-with-claude/claude-platform-on-aws) | `claude-opus-4-8`           |
...
<CardGroup cols={3}>
  <Card title="迁移到 Claude Opus 5" icon="arrows-left-right" href="https://platform.claude.com/docs/zh-CN/models/opus-5/migration-guide#migrating-from-claude-opus-4-8-to-claude-opus-5">
    从 Claude Opus 4.8 迁移到 Claude Opus 5 时会发生哪些变化。
  </Card>
  ...
  <Card title="为 Claude Opus 4.8 编写提示" icon="lightbulb" href="https://platform.claude.com/docs/zh-CN/build-with-claude/prompt-engineering/prompting-claude-opus-4-8">
    特定于模型的提示指导。
  </Card>
</CardGroup>
...
<CardGroup cols={3}>
  <Card title="系统提示" icon="text" href="https://platform.claude.com/docs/zh-CN/release-notes/system-prompts#claude-opus-4-8">
    Claude Opus 4.8 在 claude.ai 和 Claude 应用上使用的系统提示。
  </Card>

  <Card title="系统卡" icon="file" href="https://www.anthropic.com/claude-opus-4-8-system-card">
    Claude Opus 4.8 的安全评估和部署决策。
  </Card>
