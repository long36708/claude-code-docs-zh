...
开发者工具的采用很少是因为推出公告而发生的。它发生在团队中有人开始很好地使用该工具、公开谈论它，并使其他人容易跟随的时候。你作为倡导者所做的工作具有不成比例的效果：你分享的每个例子都会缩短后来工程师的学习曲线，你公开回答的每个问题都会将一个人的经验转化为整个团队可以建立的东西。
...
目标是建立少量轻量级的习惯，允许势头在你停止主动推动它之后继续。你不需要建立一个程序或拥有一个推出。当频道中的问题被除你之外的人回答时，该角色已经完成了它的工作。
