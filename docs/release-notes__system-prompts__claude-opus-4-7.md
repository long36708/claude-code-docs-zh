---
title: Claude Opus 4.7 系统提示
url: https://platform.claude.com/docs/zh-CN/release-notes/system-prompts/claude-opus-4-7
description: 查看 [claude.ai](https://claude.ai)、[Claude iOS 应用](https://anthropic.com/ios)和 [Claude Android 应用](https://anthropic.com/android)上 Claude Opus 4.7 核心系统提示的更新。
---
