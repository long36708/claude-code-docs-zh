---
title: Claude Opus 5 系统提示
url: https://platform.claude.com/docs/zh-CN/release-notes/system-prompts/claude-opus-5
description: 查看 [claude.ai](https://claude.ai) 以及 [Claude iOS 应用](https://anthropic.com/ios)和 [Claude Android 应用](https://anthropic.com/android)上 Claude Opus 5 核心系统提示的更新。
---
